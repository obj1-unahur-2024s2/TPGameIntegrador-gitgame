...
/*RECIBIR DAÑO*/	
	...
	keyboard.h().onPressDo({ astronauta1.disparar()  sonidoDisparo.play()})
...
/*SONIDO*/	
object musica{
	const sonidoAmbiente = game.sound("MusicaAmbiente.mp3")
...
object sonidoDisparo{
	...
	method play () {game.sound("SonidoDisparo1.mp3").play()}
